...
//  MahonyQuaternionUpdate(ax, ay, az, gx*PI/180.0f, gy*PI/180.0f, gz*PI/180.0f, my, mx, mz);
    ...
    if(SerialDebug) {
    //Serial.print("ax = "); Serial.print((int)1000*ax);   Serial.print(" ay = "); Serial.print((int)1000*ay);   Serial.print(" az = "); Serial.print((int)1000*az); Serial.println(" mg");
   // Serial.print("gx = "); Serial.print( gx, 2);   Serial.print(" gy = "); Serial.print( gy, 2);    Serial.print(" gz = "); Serial.print( gz, 2); Serial.println(" deg/s");
    //Serial.print("mx = "); Serial.print( (int)mx );   Serial.print(" my = "); Serial.print( (int)my );    Serial.print(" mz = "); Serial.print( (int)mz ); Serial.println(" mG");
    
    Serial.print("X:"); if (q[1]<0) {Serial.print(q[1],3);} else {Serial.print(" "); Serial.print(q[1],3);}
    Serial.print(" Y:"); if (q[2]<0) {Serial.print(q[2],3);} else {Serial.print(" "); Serial.print(q[2],3);}
    Serial.print(" Z:"); if (q[3]<0) {Serial.print(q[3],3);} else {Serial.print(" "); Serial.print(q[3],3);} 
    Serial.print(" W:"); if (q[0]<0) {Serial.println(q[0],3);} else {Serial.print(" "); Serial.println(q[0],3);}
    }               
